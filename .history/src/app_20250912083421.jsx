  ...
  return (
    <div className="w-[463px] max-w-md h-screen mx-auto bg-white overflow-x-hidden relative">
      ...
      >
        ...
        <div className="h-[30rem] w-full bg-center flex flex-col items-center justify-center px-4 bg-[#e6cbba]">
          <h2 className="text-[#6e4f40] text-[2.4rem] mb-[0.6rem]">Wedding gift</h2>
          <p className="text-[#6e4f40] text-[14px] mb-[1.4rem]">Bagi bapak/ibu/saudara/i yang ingin mengirimkan hadiah<br/>pernikahan dapat melalui nomer rekening di bawah ini</p>
