  ...
  return (
    <div className="w-[463px] max-w-md h-screen mx-auto bg-white overflow-x-hidden relative">
      ...
      >
        ...
        >
          <p className="text-[#6e4f40] text-[14px]" style={{ fontWeight: 'inherit' }}>Merupakan suatu kebahagian dan kehormatan bagi kami, apabila<br/>Bapak/Ibu/Saudara/i, berkenan hadir dan memberikan do'a restu<br/>kepada kami</p>
